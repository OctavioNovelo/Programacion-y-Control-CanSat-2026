...
// Pines para ESP32 XIAO Sense S3 + SX1278
// NSS: D6, DIO0: D4, RST: D5, DIO1: RADIOLIB_NC (No listado)
SX1278 radio = new Module(D6, D4, D5, RADIOLIB_NC);
...
void loop() {
  if (currentMode == MODE_LORA) {
    ...
    if (state == RADIOLIB_ERR_NONE) {
      ...
      // Reenviar binario en FSK también
    }
  }
}
